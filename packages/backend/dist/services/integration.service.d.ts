export declare class IntegrationService {
    ...
    connectGoogleCalendar(userId: string, authCode: string): Promise<{
        connected: boolean;
        calendars: any;
    }>;
    syncBookingToGoogleCalendar(bookingId: string, userId: string): Promise<any>;
    connectQuickBooks(studioId: string, authCode: string): Promise<{
        connected: boolean;
        companyName: any;
    }>;
    syncInvoiceToQuickBooks(invoiceId: string): Promise<any>;
    sendZapierWebhook(event: string, data: any): Promise<void>;
    sendSlackNotification(studioId: string, channel: string, message: {
        text: string;
        blocks?: any[];
        attachments?: any[];
    }): Promise<void>;
    uploadToDropbox(studioId: string, files: Array<{
        path: string;
        content: Buffer;
