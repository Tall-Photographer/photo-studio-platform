...
exports.reportFiltersSchema = exports.searchLocationsSchema = exports.updateSettingSchema = exports.updateExpenseSchema = exports.createExpenseSchema = exports.createEmailCampaignSchema = exports.sendEmailSchema = exports.uploadFileSchema = exports.processPaymentSchema = exports.createPaymentSchema = exports.updateInvoiceSchema = exports.createInvoiceSchema = exports.updateProjectSchema = exports.createProjectSchema = exports.updateRoomSchema = exports.createRoomSchema = exports.updateEquipmentSchema = exports.createEquipmentSchema = exports.updateBookingSchema = exports.createBookingSchema = exports.updateClientSchema = exports.createClientSchema = exports.updateUserSchema = exports.createUserSchema = exports.updateStudioSchema = exports.createStudioSchema = exports.resetPasswordSchema = exports.loginSchema = exports.registerSchema = exports.dateRangeSchema = exports.currencySchema = exports.phoneSchema = exports.emailSchema = exports.idSchema = exports.paginationSchema = void 0;
...
exports.phoneSchema = zod_1.z.string().regex(/^\+?[1-9]\d{1,14}$/, 'Invalid phone number format').optional();
...
exports.createClientSchema = zod_1.z.object({
    ...
    country: zod_1.z.string().length(2).optional(),
    postalCode: zod_1.z.string().optional(),
    preferredContactMethod: zod_1.z.enum(['email', 'phone', 'sms']).default('email'),
...
exports.createBookingSchema = zod_1.z.object({
    ...
    preferredWeather: zod_1.z.array(zod_1.z.nativeEnum(client_1.WeatherCondition)).optional(),
